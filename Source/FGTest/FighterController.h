...
private:
	...
	const TMap<EInputType, TArray<EInputType>> MotionInputs = {
		...
		{EInputType::FQCH, {EInputType::DOWN, EInputType::DOWNRIGHT, EInputType::RIGHT, EInputType::HB} },
		{EInputType::BQCL, {EInputType::DOWN, EInputType::DOWNLEFT, EInputType::LEFT, EInputType::LB} },
